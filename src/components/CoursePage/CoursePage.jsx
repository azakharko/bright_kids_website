...
const CoursePage = ({ setBurgerOpen, burgerOpen, handleLanguageChange }) => {
	...
	const keywordsEnglish = "study ukrainian language, ukrainian language learning, learn ukrainian online, learn to speak ukrainian, basic ukraine language, ukrainian for beginners, ukrainian teachers, online ukrainian course, ukrainian language course, ukrainian lessons for beginners, ukraine language lessons, ukrainian language classes, ukrainian classes online";
	...
	return (
		<div className='Course'>
			...
			<Helmet>
				<title>{t(`CoursePage.course${courseIndex}.title`)} | {t(`SEO.title`)}</title>
			</Helmet>

			{(t(`CoursePage.course${courseIndex}.title`) === "Ukrainian Language Course" || t(`CoursePage.course${courseIndex}.title`) === "Курс Української мови") && (
				<Helmet>
			...
			<div className={`CoursePage ${t(`CoursePage.course${courseIndex}.title`) === "Ukrainian Language Course" || t(`CoursePage.course${courseIndex}.title`) === "Курс Української мови" ? 'CoursePage CoursePage__specific' : 'CoursePage'}`}>
				<FormPopup status={formSubmitted} ч/>
				...
				{showForm ? (
					...
					<div className="CoursePage__left">
						<div className="CoursePage__left-containers">
							<ul>
						...
						<div className='CoursePage__left-description'>
						<h2 style={{color: '#B41D8A', textAlign: 'center'}}>{t(`CoursePage.course${courseIndex}.subTitle2`)}</h2>
					...
					<div className="CoursePage__rigth">
						<div className="CoursePage__rigth-img">
							<img src={imagePath} alt={`уроки курси вивчення української мови онлайн brightkids.online study ukrainian learn language course lessons`} />
						</div>
					</div>
				</>
